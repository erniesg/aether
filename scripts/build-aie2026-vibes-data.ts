  ...
  const publicData = {
    ...
    methodology: {
      ...
      limitations: [
        ...
        'Clusters are story assignments over whole posts. Broad recaps stay intact as recap refs and can carry secondary story mentions.',
        'Core refs seed story assignment; context refs are event texture, media, replies, or logistics attached for browsing but not used as story roots.',
        ...
        'TF-IDF diagnostics are retained for auditability, but visible clusters use story labels rather than raw top-keyword clusters.',
      ],
    },
    stats: archive.stats,
