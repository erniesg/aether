...
complete the device flow from a browser where you are signed in. Claude Code
prints its own interactive browser/device login steps when `claude` starts.
