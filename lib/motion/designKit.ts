...
const COMPONENT_ROLES = {
  ...
  'cursor-callout': 'focus cue',
  'split-screen-compare': 'before after',
  'avatar-bubble': 'presenter context',
  'device-frame': 'device capture',
  'logo-motion': 'brand reveal',
  'flow-diagram': 'flow explanation',
  'hotspot-marker': 'interactive marker',
  ...
  'contact-sheet-proof': 'render proof',
  'outro-slate': 'outro',
