      ...
      items: expect.arrayContaining([
        expect.objectContaining({
          ...
          artifactPlan: {
            ...
            editableSurfaceLabels: expect.arrayContaining(['script', 'component', 'effect']),
            expectedReceiptLabels: ['draft variation', 'timeline revision', 'updated preview plan'],
            blockerLabels: [],
          },
        ...
        expect.objectContaining({
          ...
          artifactPlan: {
            status: 'ready',
            engineLabel: 'remotion',
            timelinePath: 'timeline/draft-proof-first.json',
            sourcePathLabels: [
              'timeline/draft-proof-first.json',
              'SCRIPT.md',
              'STORYBOARD.md',
              'EDIT.md',
            ],
    ...
    expect(preview.capabilitySetup.items).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          label: 'Timeline sync',
          status: 'blocked',
          blockerLabels: ['Approve a draft variation before timeline sync'],
        }),
        expect.objectContaining({
          id: 'render',
          label: 'Render proof',
