...
const tool: Anthropic.Messages.Tool = {
  ...
  description:
    'Inspect a stored mixed X + LinkedIn event corpus and suggest the next search frontier: accounts, hashtags, entities, and expanded queries, with cited sample post ids.',
  input_schema: {
    type: 'object',
    properties: {
      eventId: {
